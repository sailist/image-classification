"""
    ...
    - [code](https://github.com/facebookresearch/swav)[official]
"""
...
class SwAvTrainer(SSLTrainer):
    ...
    def imodels(self, params: ParamsType):
        ...
        self.model = SwAvModule(params.model,
    ...
    def train_step(self, batch, params: ParamsType = None) -> MetricType:
        ...
        if params.train_linear:
            Lx = F.cross_entropy(output0.logits, ys)
