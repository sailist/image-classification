...
ParamsType = InfoMinParams


class InfoMinModule(nn.Module):
...
class InfoMinTrainer(SSLTrainer):
    ...
    def imodels(self, params: ParamsType):
        ...
        self.model = InfoMinModule(params.model,
