...
# Contrastive Multiview Coding(CMC)
    - [code](https://github.com/HobbitLong/CMC)[official]
"""
...
class CMCTrainer(SSLTrainer):
    ...
    def imodels(self, params: ParamsType):
        ...
        self.model = CMCModule(params.model,
